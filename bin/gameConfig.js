...
module.exports = [{
	...
	"skills":[
		{skill:"vortex",type:"active", damage:10000,radius:5,nowCoolDown:1000,coolDown:1000},
	...
	"skills":[
		...
		{skill:"radiance",type:"passive",damage:20,radius:2,nowCoolDown:0,coolDown:0},
		{skill:"forceStaff",type:"active",speed:3,nowCoolDown:20,coolDown:20},
		{skill:"spawnMob",type:"active",object:"JohnCena",nowCoolDown:20,coolDown:20}
	],
	"lvlInfo":[{"lvl": 1,"upgrade": "attackRadius","step": 1,"maxLvl": 10,"price": 300},{"lvl": 1,"upgrade": "hp","step": 1000,"maxLvl": 5,"price": 300}]
},{
	"type": "BOMB",
	...
	"price": 0,
	"moveTargets": false,
	"attackTargets": ["JohnCena","ORK","HUNTER","TROLL","IRONMAN"],
	"damage": 25,
	"moveSpeed": 1,
	"attackSpeed": 1,
	"attackRadius": 2,
	...
	"hp": 100,
	"price": 0,
	"moveTargets": ["TITAN","IRONMAN"],
	"attackTargets": ["TITAN","IRONMAN"],
	"damage": 1,
	"moveSpeed": 1,
	"attackSpeed": 1,
	"attackRadius": 2,
	"block": false,
	"skills":[
		{skill:"dieJohn",type:"active",nowCoolDown:0,coolDown:20}
	]
}];